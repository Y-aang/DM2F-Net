...
# exp_name = 'ohaze_attention_add_1'
exp_name = 'ohaze_attention_add_unet'
...
args = {
    ...
    'snapshot': 'iter_16000_loss_0.04662_lr_0.000047',
}
    ...
    with torch.no_grad():
        ...
        for name, root in to_test.items():
            if 'SOTS' in name:
                ...
                # net = DM2FNet_woPhy_loss_weight_x0().cuda()
                # net = DM2FNet_woPhy_pro().cuda()
                net = DM2FNet_woPhy_Unet().cuda()
