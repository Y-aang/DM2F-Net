...
from model import DM2FNet_woPhy_loss_weight_x0, DM2FNet_woPhy_inference_weight_x0, \
    DM2FNet_woPhy_pro, DM2FNet_woPhy_Unet
...
def parse_args():
    ...
    parser.add_argument(
        '--exp-name',
        default='ohaze_attention_add_unet',
...
def main():
    # net = DM2FNet_woPhy_pro().to(device).train()
    # net = DM2FNet_woPhy_pro().to(device).train()
    net = DM2FNet_woPhy_Unet().to(device).train()
